...
const kBanks = <BankOption>[
  ...
  BankOption(
    ...
    icon: Icons.account_balance,
    profileId: 'chase_notif',
    defaultCurrency: 'USD',
  ),
  BankOption(
    id: 'wellsfargo',
    name: 'Wells Fargo',
    color: Color(0xFFD71E28),
    icon: Icons.account_balance,
    profileId: 'wellsfargo_notif',
    defaultCurrency: 'USD',
  ),
  BankOption(
    id: 'citi',
