...
class _CategoryFormPageState extends State<CategoryFormPage> {
  ...
  void _fillForm() {
    CategoryService.instance.getCategoryById(widget.categoryUUID!).first.then((
      category,
    ) async {
  ...
  Future<void> submitForm() async {
    if (categoryToEdit != null) {
      ...
      await CategoryService.instance
          ...
          .then((value) {
            NitidoSnackbar.success(SnackbarParams(t.categories.edit_success));
          })
          .catchError((error) {
      ...
      if (await query.watchSingleOrNull().first != null) {
        NitidoSnackbar.error(SnackbarParams(t.categories.already_exists));
        return;
      }
