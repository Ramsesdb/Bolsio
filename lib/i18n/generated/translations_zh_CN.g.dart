...
extension on TranslationsZhCn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'home.no_accounts_descr' => '要开始使用 Monekin，请创建至少一个账户，以便开始添加交易',
			...
			'financial_health.review.descr.very_good' => '恭喜！您的财务状况非常好。我们希望您能够继续保持，并继续和 Monekin 一起学习。',
			...
			'transaction.status.unreconciled_descr' => '此交易尚未被核实，因此尚未出现在您的真实银行账户中。然而，在 Monekin 中，它将被用于计算余额和其它统计数据',
			...
			'backup.import.restore_backup_descr' => '导入一个从 Monekin 保存的数据库。此操作将用新数据覆盖当前应用数据',
			'backup.import.restore_backup_warn_description' => '导入新数据库时，您将丟失应用中当前保存的所有数据。建议在继续之前进行备份。请勿在此上传任何来源不明的文件，仅上传您之前从 Monekin 下载的文件',
			...
			'more.about_us.description' => '查找 Monekin 的条款、重要信息，并通过报告错误或分享想法与我们联系',
			...
			'more.about_us.project.contributors_descr' => '所有让 Monekin 成长的开发者',
			'more.about_us.project.contact' => '联系我们',
			'more.help_us.display' => '帮助我们',
			'more.help_us.description' => '了解如何帮助 Monekin 变得越来越好',
			...
			'more.help_us.share_text' => 'Monekin！最好的个人理财应用 。此处下载',
			'more.help_us.thanks' => '谢谢您！',
			'more.help_us.thanks_long' => '您对 Monekin 和其它大大小小的开源项目的贡献成就了这一伟大项目。感谢您花时间做出贡献。',
