...
// Path: ui_actions
class _TranslationsUiActionsZhCn extends TranslationsUiActionsEn {
	_TranslationsUiActionsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsFinancialHealthZhCn extends TranslationsFinancialHealthEn {
	_TranslationsFinancialHealthZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: stats
class _TranslationsStatsZhCn extends TranslationsStatsEn {
	_TranslationsStatsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: icon_selector
class _TranslationsIconSelectorZhCn extends TranslationsIconSelectorEn {
	_TranslationsIconSelectorZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: transaction
class _TranslationsTransactionZhCn extends TranslationsTransactionEn {
	_TranslationsTransactionZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: transfer
class _TranslationsTransferZhCn extends TranslationsTransferEn {
	_TranslationsTransferZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsRecurrentTransactionsZhCn extends TranslationsRecurrentTransactionsEn {
	_TranslationsRecurrentTransactionsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: currencies
class _TranslationsCurrenciesZhCn extends TranslationsCurrenciesEn {
	_TranslationsCurrenciesZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: tags
class _TranslationsTagsZhCn extends TranslationsTagsEn {
	_TranslationsTagsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: categories
class _TranslationsCategoriesZhCn extends TranslationsCategoriesEn {
	_TranslationsCategoriesZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: budgets
class _TranslationsBudgetsZhCn extends TranslationsBudgetsEn {
	_TranslationsBudgetsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: goals
class _TranslationsGoalsZhCn extends TranslationsGoalsEn {
	_TranslationsGoalsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: debts
class _TranslationsDebtsZhCn extends TranslationsDebtsEn {
	_TranslationsDebtsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsTargetTimelineStatusesZhCn extends TranslationsTargetTimelineStatusesEn {
	_TranslationsTargetTimelineStatusesZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: backup
class _TranslationsBackupZhCn extends TranslationsBackupEn {
	_TranslationsBackupZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsZhCn extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsAutoImportZhCn auto_import = _TranslationsSettingsAutoImportZhCn._(_root);
	@override late final _TranslationsSettingsAppearanceZhCn appearance = _TranslationsSettingsAppearanceZhCn._(_root);
}

// Path: more
class _TranslationsMoreZhCn extends TranslationsMoreEn {
	_TranslationsMoreZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsMoreSearchZhCn search = _TranslationsMoreSearchZhCn._(_root);
	@override late final _TranslationsMoreSectionsZhCn sections = _TranslationsMoreSectionsZhCn._(_root);
	@override late final _TranslationsMoreAccountZhCn account = _TranslationsMoreAccountZhCn._(_root);
	@override late final _TranslationsMoreThemeZhCn theme = _TranslationsMoreThemeZhCn._(_root);
	@override late final _TranslationsMoreAiZhCn ai = _TranslationsMoreAiZhCn._(_root);
...
class _TranslationsGeneralLeaveWithoutSavingZhCn extends TranslationsGeneralLeaveWithoutSavingEn {
	_TranslationsGeneralLeaveWithoutSavingZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGeneralClipboardZhCn extends TranslationsGeneralClipboardEn {
	_TranslationsGeneralClipboardZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: general.time
class _TranslationsGeneralTimeZhCn extends TranslationsGeneralTimeEn {
	_TranslationsGeneralTimeZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGeneralTransactionOrderZhCn extends TranslationsGeneralTransactionOrderEn {
	_TranslationsGeneralTransactionOrderZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGeneralValidationsZhCn extends TranslationsGeneralValidationsEn {
	_TranslationsGeneralValidationsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsFinancialHealthReviewZhCn extends TranslationsFinancialHealthReviewEn {
	_TranslationsFinancialHealthReviewZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsFinancialHealthMonthsWithoutIncomeZhCn extends TranslationsFinancialHealthMonthsWithoutIncomeEn {
	_TranslationsFinancialHealthMonthsWithoutIncomeZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsFinancialHealthSavingsPercentageZhCn extends TranslationsFinancialHealthSavingsPercentageEn {
	_TranslationsFinancialHealthSavingsPercentageZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsIconSelectorScopesZhCn extends TranslationsIconSelectorScopesEn {
	_TranslationsIconSelectorScopesZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsTransactionNextPaymentsZhCn extends TranslationsTransactionNextPaymentsEn {
	_TranslationsTransactionNextPaymentsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsTransactionListZhCn extends TranslationsTransactionListEn {
	_TranslationsTransactionListZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsTransactionFiltersZhCn extends TranslationsTransactionFiltersEn {
	_TranslationsTransactionFiltersZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsTransactionFormZhCn extends TranslationsTransactionFormEn {
	_TranslationsTransactionFormZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsTransactionReversedZhCn extends TranslationsTransactionReversedEn {
	_TranslationsTransactionReversedZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsTransactionStatusZhCn extends TranslationsTransactionStatusEn {
	_TranslationsTransactionStatusZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsTransactionTypesZhCn extends TranslationsTransactionTypesEn {
	_TranslationsTransactionTypesZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: transfer.form
class _TranslationsTransferFormZhCn extends TranslationsTransferFormEn {
	_TranslationsTransferFormZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsRecurrentTransactionsDetailsZhCn extends TranslationsRecurrentTransactionsDetailsEn {
	_TranslationsRecurrentTransactionsDetailsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsRecurrentTransactionsStatusZhCn extends TranslationsRecurrentTransactionsStatusEn {
	_TranslationsRecurrentTransactionsStatusZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: account.types
class _TranslationsAccountTypesZhCn extends TranslationsAccountTypesEn {
	_TranslationsAccountTypesZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: account.form
class _TranslationsAccountFormZhCn extends TranslationsAccountFormEn {
	_TranslationsAccountFormZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: account.delete
class _TranslationsAccountDeleteZhCn extends TranslationsAccountDeleteEn {
	_TranslationsAccountDeleteZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: account.close
class _TranslationsAccountCloseZhCn extends TranslationsAccountCloseEn {
	_TranslationsAccountCloseZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: account.select
class _TranslationsAccountSelectZhCn extends TranslationsAccountSelectEn {
	_TranslationsAccountSelectZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsCurrenciesExchangeRateFormZhCn extends TranslationsCurrenciesExchangeRateFormEn {
	_TranslationsCurrenciesExchangeRateFormZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsCurrenciesTypesZhCn extends TranslationsCurrenciesTypesEn {
	_TranslationsCurrenciesTypesZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsCurrenciesCurrencyFormZhCn extends TranslationsCurrenciesCurrencyFormEn {
	_TranslationsCurrenciesCurrencyFormZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: tags.form
class _TranslationsTagsFormZhCn extends TranslationsTagsFormEn {
	_TranslationsTagsFormZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: tags.select
class _TranslationsTagsSelectZhCn extends TranslationsTagsSelectEn {
	_TranslationsTagsSelectZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsCategoriesSelectZhCn extends TranslationsCategoriesSelectEn {
	_TranslationsCategoriesSelectZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: budgets.form
class _TranslationsBudgetsFormZhCn extends TranslationsBudgetsFormEn {
	_TranslationsBudgetsFormZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsBudgetsDetailsZhCn extends TranslationsBudgetsDetailsEn {
	_TranslationsBudgetsDetailsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsBudgetsTargetTimelineStatusesZhCn extends TranslationsBudgetsTargetTimelineStatusesEn {
	_TranslationsBudgetsTargetTimelineStatusesZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsBudgetsProgressZhCn extends TranslationsBudgetsProgressEn {
	_TranslationsBudgetsProgressZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: goals.type
class _TranslationsGoalsTypeZhCn extends TranslationsGoalsTypeEn {
	_TranslationsGoalsTypeZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: goals.form
class _TranslationsGoalsFormZhCn extends TranslationsGoalsFormEn {
	_TranslationsGoalsFormZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: goals.details
class _TranslationsGoalsDetailsZhCn extends TranslationsGoalsDetailsEn {
	_TranslationsGoalsDetailsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGoalsTargetTimelineStatusesZhCn extends TranslationsGoalsTargetTimelineStatusesEn {
	_TranslationsGoalsTargetTimelineStatusesZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: goals.progress
class _TranslationsGoalsProgressZhCn extends TranslationsGoalsProgressEn {
	_TranslationsGoalsProgressZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: debts.form
class _TranslationsDebtsFormZhCn extends TranslationsDebtsFormEn {
	_TranslationsDebtsFormZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsDebtsDirectionZhCn extends TranslationsDebtsDirectionEn {
	_TranslationsDebtsDirectionZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: debts.status
class _TranslationsDebtsStatusZhCn extends TranslationsDebtsStatusEn {
	_TranslationsDebtsStatusZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: debts.details
class _TranslationsDebtsDetailsZhCn extends TranslationsDebtsDetailsEn {
	_TranslationsDebtsDetailsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: debts.empty
class _TranslationsDebtsEmptyZhCn extends TranslationsDebtsEmptyEn {
	_TranslationsDebtsEmptyZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: debts.actions
class _TranslationsDebtsActionsZhCn extends TranslationsDebtsActionsEn {
	_TranslationsDebtsActionsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsDebtsActionsUnlinkTransactionZhCn unlink_transaction = _TranslationsDebtsActionsUnlinkTransactionZhCn._(_root);
...
// Path: backup.export
class _TranslationsBackupExportZhCn extends TranslationsBackupExportEn {
	_TranslationsBackupExportZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: backup.import
class _TranslationsBackupImportZhCn extends TranslationsBackupImportEn {
	_TranslationsBackupImportZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: backup.about
class _TranslationsBackupAboutZhCn extends TranslationsBackupAboutEn {
	_TranslationsBackupAboutZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsGeneralZhCn extends TranslationsSettingsGeneralEn {
	...
	@override String get show_all_decimals => '显示所有小数位';
	@override String get show_all_decimals_descr => '即便是末尾为零，也显示所有小数位';
...
class _TranslationsSettingsSecurityZhCn extends TranslationsSettingsSecurityEn {
	_TranslationsSettingsSecurityZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsSecurityBiometricZhCn biometric = _TranslationsSettingsSecurityBiometricZhCn._(_root);
}

// Path: settings.transactions
class _TranslationsSettingsTransactionsZhCn extends TranslationsSettingsTransactionsEn {
	_TranslationsSettingsTransactionsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsTransactionsStyleZhCn style = _TranslationsSettingsTransactionsStyleZhCn._(_root);
...
class _TranslationsSettingsAutoImportZhCn extends TranslationsSettingsAutoImportEn {
	_TranslationsSettingsAutoImportZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);

	final TranslationsZhCn _root; // ignore: unused_field

	// Translations
	@override String get menu_title => '银行自动导入';
}
...
// Path: more.search
class _TranslationsMoreSearchZhCn extends TranslationsMoreSearchEn {
	_TranslationsMoreSearchZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: more.sections
class _TranslationsMoreSectionsZhCn extends TranslationsMoreSectionsEn {
	_TranslationsMoreSectionsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: more.account
class _TranslationsMoreAccountZhCn extends TranslationsMoreAccountEn {
	_TranslationsMoreAccountZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: more.theme
class _TranslationsMoreThemeZhCn extends TranslationsMoreThemeEn {
	_TranslationsMoreThemeZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: more.ai
class _TranslationsMoreAiZhCn extends TranslationsMoreAiEn {
	_TranslationsMoreAiZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: more.data
class _TranslationsMoreDataZhCn extends TranslationsMoreDataEn {
	_TranslationsMoreDataZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: more.about_us
class _TranslationsMoreAboutUsZhCn extends TranslationsMoreAboutUsEn {
	_TranslationsMoreAboutUsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
// Path: more.help_us
class _TranslationsMoreHelpUsZhCn extends TranslationsMoreHelpUsEn {
	_TranslationsMoreHelpUsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGeneralTimeRangesZhCn extends TranslationsGeneralTimeRangesEn {
	_TranslationsGeneralTimeRangesZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGeneralTimePeriodicityZhCn extends TranslationsGeneralTimePeriodicityEn {
	_TranslationsGeneralTimePeriodicityZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGeneralTimeCurrentZhCn extends TranslationsGeneralTimeCurrentEn {
	_TranslationsGeneralTimeCurrentZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGeneralTimeAllZhCn extends TranslationsGeneralTimeAllEn {
	_TranslationsGeneralTimeAllZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsFinancialHealthReviewDescrZhCn extends TranslationsFinancialHealthReviewDescrEn {
	_TranslationsFinancialHealthReviewDescrZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsFinancialHealthSavingsPercentageTextZhCn extends TranslationsFinancialHealthSavingsPercentageTextEn {
	_TranslationsFinancialHealthSavingsPercentageTextZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsTransactionListBulkEditZhCn extends TranslationsTransactionListBulkEditEn {
	_TranslationsTransactionListBulkEditZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsTransactionFiltersSavedZhCn extends TranslationsTransactionFiltersSavedEn {
	_TranslationsTransactionFiltersSavedZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsTransactionFormValidatorsZhCn extends TranslationsTransactionFormValidatorsEn {
	_TranslationsTransactionFormValidatorsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsTransferFormValueInDestinyZhCn extends TranslationsTransferFormValueInDestinyEn {
	_TranslationsTransferFormValueInDestinyZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsBudgetsProgressLabelsZhCn extends TranslationsBudgetsProgressLabelsEn {
	_TranslationsBudgetsProgressLabelsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsBudgetsProgressDescriptionZhCn extends TranslationsBudgetsProgressDescriptionEn {
	_TranslationsBudgetsProgressDescriptionZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGoalsTypeIncomeZhCn extends TranslationsGoalsTypeIncomeEn {
	_TranslationsGoalsTypeIncomeZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGoalsTypeExpenseZhCn extends TranslationsGoalsTypeExpenseEn {
	_TranslationsGoalsTypeExpenseZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGoalsProgressLabelsZhCn extends TranslationsGoalsProgressLabelsEn {
	_TranslationsGoalsProgressLabelsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGoalsProgressDescriptionZhCn extends TranslationsGoalsProgressDescriptionEn {
	_TranslationsGoalsProgressDescriptionZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsDebtsFormFromTransactionZhCn extends TranslationsDebtsFormFromTransactionEn {
	_TranslationsDebtsFormFromTransactionZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsDebtsFormFromAmountZhCn extends TranslationsDebtsFormFromAmountEn {
	_TranslationsDebtsFormFromAmountZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsDebtsActionsEditZhCn extends TranslationsDebtsActionsEditEn {
	_TranslationsDebtsActionsEditZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsDebtsActionsDeleteZhCn extends TranslationsDebtsActionsDeleteEn {
	_TranslationsDebtsActionsDeleteZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsDebtsActionsAddRegisterZhCn extends TranslationsDebtsActionsAddRegisterEn {
	_TranslationsDebtsActionsAddRegisterZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsDebtsActionsLinkTransactionZhCn extends TranslationsDebtsActionsLinkTransactionEn {
	_TranslationsDebtsActionsLinkTransactionZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsDebtsActionsUnlinkTransactionZhCn extends TranslationsDebtsActionsUnlinkTransactionEn {
	_TranslationsDebtsActionsUnlinkTransactionZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsDebtsActionsNewTransactionZhCn extends TranslationsDebtsActionsNewTransactionEn {
	_TranslationsDebtsActionsNewTransactionZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsDebtsActionsCreateZhCn extends TranslationsDebtsActionsCreateEn {
	_TranslationsDebtsActionsCreateZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsBackupImportManualImportZhCn extends TranslationsBackupImportManualImportEn {
	_TranslationsBackupImportManualImportZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsGeneralLanguageZhCn extends TranslationsSettingsGeneralLanguageEn {
	_TranslationsSettingsGeneralLanguageZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsGeneralLocaleZhCn extends TranslationsSettingsGeneralLocaleEn {
	_TranslationsSettingsGeneralLocaleZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsSecurityBiometricZhCn extends TranslationsSettingsSecurityBiometricEn {
	_TranslationsSettingsSecurityBiometricZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
	...
	@override String get section_title => '生物识别锁';
}

// Path: settings.transactions.style
class _TranslationsSettingsTransactionsStyleZhCn extends TranslationsSettingsTransactionsStyleEn {
	_TranslationsSettingsTransactionsStyleZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);

	final TranslationsZhCn _root; // ignore: unused_field

	// Translations
	@override String get title => '交易样式';
	@override String get subtitle => '配置交易在应用列表中的显示方式';
	@override String get show_tags => '显示标签';
	@override String get show_time => '显示时间';
}

// Path: settings.transactions.swipe_actions
class _TranslationsSettingsTransactionsSwipeActionsZhCn extends TranslationsSettingsTransactionsSwipeActionsEn {
	_TranslationsSettingsTransactionsSwipeActionsZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsTransactionsDefaultValuesZhCn extends TranslationsSettingsTransactionsDefaultValuesEn {
	_TranslationsSettingsTransactionsDefaultValuesZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsTransactionsDefaultTypeZhCn extends TranslationsSettingsTransactionsDefaultTypeEn {
	_TranslationsSettingsTransactionsDefaultTypeZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsMoreAboutUsLegalZhCn extends TranslationsMoreAboutUsLegalEn {
	_TranslationsMoreAboutUsLegalZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsMoreAboutUsProjectZhCn extends TranslationsMoreAboutUsProjectEn {
	_TranslationsMoreAboutUsProjectZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
class _TranslationsGeneralTimeRangesTypesZhCn extends TranslationsGeneralTimeRangesTypesEn {
	_TranslationsGeneralTimeRangesTypesZhCn._(TranslationsZhCn root) : this._root = root, super.internal(root);
...
extension on TranslationsZhCn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'ui_actions.confirm' => '确认',
			'ui_actions.continue_text' => '继续',
			'ui_actions.save' => '保存',
			'ui_actions.save_changes' => '保存更改',
			'ui_actions.close_and_save' => '保存并关闭',
			'ui_actions.add' => '添加',
			'ui_actions.edit' => '编辑',
			'ui_actions.delete' => '删除',
			'ui_actions.see_more' => '查看更多',
			'ui_actions.select_all' => '全选',
			'ui_actions.deselect_all' => '取消全选',
			'ui_actions.select' => '选择',
			'ui_actions.search' => '搜索',
			'ui_actions.filter' => '筛选',
			'ui_actions.reset' => '重置',
			'ui_actions.submit' => '提交',
			'ui_actions.next' => '下一步',
			'ui_actions.previous' => '上一步',
			'ui_actions.back' => '返回',
			'ui_actions.reload' => '重新加载',
			'ui_actions.view' => '视图',
			'ui_actions.download' => '下载',
			'ui_actions.upload' => '上传',
			'ui_actions.retry' => '重试',
			'ui_actions.copy' => '复制',
			'ui_actions.paste' => '粘贴',
			'ui_actions.undo' => '撤销',
			...
			'ui_actions.close' => '关闭',
			'ui_actions.apply' => '应用',
			'ui_actions.discard' => '放弃',
			'ui_actions.refresh' => '刷新',
			'ui_actions.share' => '分享',
			'general.or' => '或',
			'general.understood' => '明白',
			'general.unspecified' => '未指定',
			'general.quick_actions' => '快捷行动',
			'general.details' => '细节',
			'general.balance' => '余额',
			'general.account' => '账户',
			'general.accounts' => '账户',
			'general.categories' => '类别',
			'general.category' => '类别',
			'general.today' => '今天',
			'general.yesterday' => '昨天',
			'general.filters' => '筛选',
			'general.empty_warn' => '喔！这里什么都没有',
			'general.search_no_results' => '没有符合您搜索条件的商品',
			'general.insufficient_data' => '数据不足',
			'general.show_more_fields' => '显示更多',
			'general.show_less_fields' => '显示更少',
			'general.tap_to_search' => '点击以搜索',
			'general.delete_success' => '项目删除成功',
			'general.leave_without_saving.title' => '不保存就离开？',
			'general.leave_without_saving.message' => '您有未保存的更改，确定要离开而不保存它们吗？',
			'general.clipboard.success' => ({required Object x}) => '已复制 ${x}',
			'general.clipboard.error' => '复制出错',
			'general.time.start_date' => '开始日期',
			'general.time.end_date' => '结束日期',
			'general.time.from_date' => '从',
			'general.time.until_date' => '到',
			'general.time.date' => '日期',
			'general.time.datetime' => '日期时间',
			'general.time.time' => '时间',
			'general.time.each' => '每',
			'general.time.after' => '后',
			'general.time.ranges.display' => '时间范围',
			'general.time.ranges.it_repeat' => '重复',
			'general.time.ranges.it_ends' => '结束',
			'general.time.ranges.forever' => '永久',
			'general.time.ranges.types.cycle' => '循环',
			'general.time.ranges.types.last_days' => 'Last days',
			'general.time.ranges.types.last_days_form' => ({required Object x}) => '前${x}天',
			'general.time.ranges.types.all' => '总是',
			'general.time.ranges.types.date_range' => '自定义范围',
			'general.time.ranges.each_range' => ({required num n, required Object range}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '每${range}', other: '每${n}${range}', ), 
			...
			'general.time.ranges.week' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '星期', other: '星期', ), 
			'general.time.periodicity.display' => '重复',
			'general.time.periodicity.no_repeat' => '不重复',
			'general.time.periodicity.repeat' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '重复', other: '重复', ), 
			'general.time.periodicity.diary' => '每天',
			'general.time.periodicity.monthly' => '每月',
			'general.time.periodicity.annually' => '每年',
			'general.time.periodicity.quaterly' => '每季度',
			'general.time.periodicity.weekly' => '每周',
			'general.time.periodicity.custom' => '自定义',
			'general.time.periodicity.infinite' => '总是',
			'general.time.current.monthly' => '当月',
			'general.time.current.annually' => '今年',
			'general.time.current.quaterly' => '本季度',
			'general.time.current.weekly' => '本星期',
			'general.time.current.infinite' => '永远',
			'general.time.current.custom' => '自定义范围',
			'general.time.all.diary' => '每天',
			'general.time.all.monthly' => '每月',
			'general.time.all.annually' => '每年',
			'general.time.all.quaterly' => '每季度',
			'general.time.all.weekly' => '每周',
			'general.transaction_order.display' => '排序',
			'general.transaction_order.category' => '按类别',
			'general.transaction_order.quantity' => '按数额',
			'general.transaction_order.date' => '按日期',
			'general.validations.form_error' => '请改正指定的项目后继续',
			'general.validations.required' => '必填项目',
			'general.validations.positive' => '应为正值',
			'general.validations.min_number' => ({required Object x}) => '应大于${x}',
			'general.validations.max_number' => ({required Object x}) => '应小于${x}',
			'home.title' => '面板',
			'home.filter_transactions' => '筛选交易',
			'home.hello_day' => '您好，',
			'home.hello_night' => '晚上好，',
			...
			'financial_health.review.normal' => ({required GenderContext context}) { switch (context) { case GenderContext.male: return '一般'; case GenderContext.female: return '一般'; } }, 
			'financial_health.review.bad' => ({required GenderContext context}) { switch (context) { case GenderContext.male: return '不好'; case GenderContext.female: return '不好'; } }, 
			...
			'financial_health.review.descr.very_bad' => '嗯，您的财务健康状况远低于应有的水平。请查看其余的图表以便进一步了解您的财务情况。',
			'financial_health.months_without_income.title' => '财富自由时长',
			'financial_health.months_without_income.subtitle' => '根据您的余额计算出您可以在无收入的情况下生活的时长',
			'financial_health.months_without_income.text_zero' => '按这样的开支速度，您无法支撑一个月！',
			'financial_health.months_without_income.text_one' => '按这样的开支速度，如果没有收入，您可以大概支撑一个月！',
			'financial_health.months_without_income.text_other' => ({required Object n}) => '按这样的开支速度，如果没有收入，您可以大概支撑 <b>${n}个月</b>。',
			'financial_health.months_without_income.text_infinite' => '按这样的开支速度，即使没有收入，您也可以维持 <b>一辈子</b>。',
			'financial_health.months_without_income.suggestion' => '请记住，建议至少保持这一数字在 5 个月以上。如果您发现您没有足够的储蓄，请减少不必要的开支。',
			'financial_health.months_without_income.insufficient_data' => '看起来我们没有足够的数据来计算您没有收入后，能够支撑几个月。请添加一些支出/收入，再来这里查看您的财务健康情况',
			'financial_health.savings_percentage.title' => '储蓄百分比',
			'financial_health.savings_percentage.subtitle' => '这段时间内您的收入中哪一部分没有被花掉',
			'financial_health.savings_percentage.text.good' => ({required Object value}) => '恭喜！您在这段时间内成功省下了 <b>${value}%</b> 的收入。看来您已经是一位专家了，请继续保持！',
			'financial_health.savings_percentage.text.normal' => ({required Object value}) => '恭喜，您在这段时间内成功省下了 <b>${value}%</b> 的收入。',
			'financial_health.savings_percentage.text.bad' => ({required Object value}) => '您在这段时间内省下了 <b>${value}%</b> 的收入。但我们认为您可以做得更好！',
			'financial_health.savings_percentage.text.very_bad' => '哇，您在这段时间内并没有任何结余。',
			'financial_health.savings_percentage.suggestion' => '请记住，建议至少将您赚到的 15-20% 存下来。',
			'stats.title' => '统计数据',
			'stats.balance' => '余额',
			'stats.final_balance' => '期末余额',
			'stats.balance_by_account' => '账户余额',
			'stats.balance_by_account_subtitle' => '我的大部分钱都在哪里？',
			'stats.balance_by_currency' => '货币余额',
			'stats.balance_by_currency_subtitle' => '我有多少的外币？',
			'stats.balance_evolution' => '余额趋势',
			'stats.balance_evolution_subtitle' => '我是否比之前更有钱了？',
			'stats.compared_to_previous_period' => '与上一段时间相比',
			'stats.cash_flow' => '现金流',
			'stats.cash_flow_subtitle' => '我的支出是否少于我的收入？',
			'stats.by_periods' => '按时间段',
			'stats.by_categories' => '按类别',
			'stats.by_tags' => '按标签',
			'stats.distribution' => '分布',
			'stats.finance_health_resume' => '总结',
			'stats.finance_health_breakdown' => '分解',
			'icon_selector.name' => '名称',
			'icon_selector.icon' => '图标',
			'icon_selector.color' => '颜色',
			'icon_selector.select_icon' => '选择一个图标',
			'icon_selector.select_color' => '选择一种颜色',
			'icon_selector.custom_color' => '自定义颜色',
			'icon_selector.current_color_selection' => '当前选择',
			'icon_selector.select_account_icon' => '确认您的账户',
			'icon_selector.select_category_icon' => '确认您的类别',
			'icon_selector.scopes.transport' => '交通',
			'icon_selector.scopes.money' => '金钱',
			'icon_selector.scopes.food' => '食物',
			'icon_selector.scopes.medical' => '医疗',
			'icon_selector.scopes.entertainment' => '休闲',
			'icon_selector.scopes.technology' => '科技',
			'icon_selector.scopes.other' => '其它',
			'icon_selector.scopes.logos_financial_institutions' => '金融机构',
			...
			'transaction.new_expense' => '新开支',
			'transaction.new_success' => '交易创建成功',
			'transaction.edit' => '编辑交易',
			'transaction.edit_success' => '交易编辑成功',
			'transaction.edit_multiple' => '批量编辑交易',
			'transaction.edit_multiple_success' => ({required Object x}) => '${x}笔交易编辑成功',
			'transaction.duplicate' => '复制交易',
			'transaction.duplicate_short' => '复制',
			'transaction.duplicate_warning_message' => '将在同一日期创建一笔完全相同的交易，继续吗？',
			'transaction.duplicate_success' => '交易复制成功',
			'transaction.delete' => '删除交易',
			'transaction.delete_warning_message' => '此操作无法撤回。将重新计算您账户的当前余额及其它所有统计数据',
			'transaction.delete_success' => '交易删除成功',
			'transaction.delete_multiple' => '批量删除交易',
			...
			'transaction.next_payments.skip_dialog_title' => '跳过交易',
			'transaction.next_payments.skip_dialog_msg' => ({required Object date}) => '此操作无法撤回。我们将把下次的日期移动至${date}',
			...
			'transaction.next_payments.accept_dialog_msg_single' => '此交易的新状态将为null。您可以随时重新编辑此交易的状态',
			'transaction.next_payments.accept_dialog_msg' => ({required Object date}) => '此操作将建立日期为 ${date} 的新交易。您可以在交易页面查看此交易的详情',
			'transaction.next_payments.recurrent_rule_finished' => '循环规则已完成，没有更多的支付！',
			'transaction.list.all' => '所有交易',
			'transaction.list.empty' => '未发现需要显示的交易。请先在应用中添加一些交易，下次再来查看',
			'transaction.list.searcher_placeholder' => '按类别、描述等搜索',
			'transaction.list.searcher_no_results' => '未找到符合搜索条件的交易',
			'transaction.list.loading' => '正在加载更多的交易……',
			'transaction.list.selected_short' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '已选择 ${n}', other: '已选择 ${n}', ), 
			'transaction.list.selected_long' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '已选择 ${n} 笔交易', other: '已选择 ${n} 笔交易', ), 
			'transaction.list.bulk_edit.dates' => '批量编辑日期',
			'transaction.list.bulk_edit.categories' => '批量编辑类别',
			'transaction.list.bulk_edit.status' => '批量编辑状态',
			'transaction.filters.title' => '交易过滤器',
			'transaction.filters.from_value' => '最小金额',
			'transaction.filters.to_value' => '最大金额',
			'transaction.filters.from_value_def' => ({required Object x}) => '从 ${x}',
			'transaction.filters.to_value_def' => ({required Object x}) => '到 ${x}',
			'transaction.filters.from_date_def' => ({required Object date}) => '从 ${date}',
			'transaction.filters.to_date_def' => ({required Object date}) => '到 ${date}',
			'transaction.filters.reset' => '重置过滤器',
			'transaction.filters.saved.title' => '已保存的过滤器',
			'transaction.filters.saved.new_title' => '新建过滤器',
			'transaction.filters.saved.edit_title' => '编辑过滤器',
			'transaction.filters.saved.name_label' => '过滤器名称',
			'transaction.filters.saved.name_hint' => '我的自定义过滤器',
			'transaction.filters.saved.save_dialog_title' => '保存过滤器',
			'transaction.filters.saved.save_tooltip' => '保存当前过滤器',
			'transaction.filters.saved.load_tooltip' => '加载已保存的过滤器',
			'transaction.filters.saved.empty_title' => '未找到已保存的过滤器',
			'transaction.filters.saved.empty_description' => '在此保存过滤器以便稍后快速访问。',
			'transaction.filters.saved.save_success' => '筛选器保存成功',
			'transaction.filters.saved.delete_success' => '筛选器删除成功',
			'transaction.form.validators.zero' => '交易数额不应为零',
			'transaction.form.validators.date_max' => '所选日期晚于当前日期。交易将新增为待办',
			'transaction.form.validators.date_after_account_creation' => '无法创建早于账户创建日期的交易',
			'transaction.form.validators.negative_transfer' => '转账数额不应为负数',
			'transaction.form.validators.transfer_between_same_accounts' => '来源于目标账户不应相同',
			'transaction.form.validators.category_required' => '保存前请选择一个类别',
			'transaction.form.title' => '交易标题',
			'transaction.form.title_short' => '标题',
			'transaction.form.value' => '数额',
			'transaction.form.tap_to_see_more' => '点击查看更多详情',
			'transaction.form.no_tags' => '-- 无标签 --',
			'transaction.form.description' => '描述',
			'transaction.form.description_info' => '点击此处输入有关此交易的详细描述',
			'transaction.form.exchange_to_preferred_title' => ({required Object currency}) => '汇率为${currency}',
			'transaction.form.exchange_to_preferred_in_date' => '交易日',
			'transaction.reversed.title' => '逆向交易',
			'transaction.reversed.title_short' => '逆向交易',
			'transaction.reversed.description_for_expenses' => '尽管是一个开支交易，但其数额为正值。此类交易可用于表示已记录开支的返还，例如退款或偿还债务。',
			'transaction.reversed.description_for_incomes' => '尽管是一个收入交易，但其数额为负值。此类交易可用于作废或更正收入记录中的错误，以反映退款或记录偿还债务。',
			'transaction.status.display' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '状态', other: '状态', ), 
			'transaction.status.display_long' => '交易状态',
			'transaction.status.tr_status' => ({required Object status}) => '${status}交易',
			'transaction.status.none' => '无状态',
			'transaction.status.none_descr' => '没有特定的状态',
			...
			'transaction.status.voided_descr' => '由于付款错误或其它原因造成的作废或取消的交易。在计算余额和其它统计数据时不会被考虑',
			'transaction.types.display' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '交易类型', other: '交易类型', ), 
			...
			'transaction.types.transfer' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '转账', other: '转账', ), 
			'transfer.display' => '转账',
			'transfer.transfers' => '转账',
			'transfer.transfer_to' => ({required Object account}) => '转账至 ${account}',
			'transfer.create' => '转账',
			'transfer.need_two_accounts_warning_header' => '哎呀！',
			'transfer.need_two_accounts_warning_message' => '至少需要两个账户才能执行此操作。如果您需要调整或编辑此账户的当前余额，请点击编辑按钮',
			'transfer.form.from' => '转出账户',
			'transfer.form.to' => '转入账户',
			'transfer.form.value_in_destiny.title' => '转账数额',
			'transfer.form.value_in_destiny.amount_short' => ({required Object amount}) => '${amount} 至目标账户',
			'recurrent_transactions.title' => '循环交易',
			'recurrent_transactions.title_short' => '循环交易',
			'recurrent_transactions.empty' => '您似乎没有任何循环交易。创建一个每周、每月或每年的循环交易，它会在此显示',
			'recurrent_transactions.total_expense_title' => '每一周期的总开支',
			'recurrent_transactions.total_expense_descr' => '* 不考虑每一循环的起止日期',
			'recurrent_transactions.details.title' => '循环交易',
			'recurrent_transactions.details.descr' => '此交易的未来的动作显示如下。您可以接受第一个动作或跳过此动作',
			'recurrent_transactions.details.last_payment_info' => '此动作是循环规则的最后一个，因此当确认此动作后，这一循环规则将被自动删除',
			'recurrent_transactions.details.delete_header' => '删除循环交易',
			'recurrent_transactions.details.delete_message' => '此操作无法撤回，不会影响您已确认/付款的交易',
			'recurrent_transactions.status.delayed_by' => ({required Object x}) => '延迟 ${x} 天',
			'recurrent_transactions.status.coming_in' => ({required Object x}) => '${x} 天内',
			'account.details' => '账户详情',
			'account.date' => '开启日期',
			'account.close_date' => '关闭日期',
			'account.reopen' => '重新开启账户',
			'account.reopen_short' => '重开账户',
			'account.reopen_descr' => '您确定要重新开启此账户吗？',
			'account.balance' => '账户余额',
			'account.n_transactions' => '交易数量',
			'account.add_money' => '增加金额',
			'account.withdraw_money' => '减少金额',
			'account.no_accounts' => '未发现应当显示的交易。请点击底部的 \'+\' 按钮新增一个交易',
			'account.types.title' => '账户类型',
			'account.types.warning' => '账户类型一旦选择，以后将无法更改',
			'account.types.normal' => '普通账户',
			'account.types.normal_descr' => '用于记录日常财务。这是最普通的账户，您可以添加支出、收入……',
			'account.types.saving' => '储蓄账户',
			'account.types.saving_descr' => '您只能从此账户中向其它账户中转入/转出（而无法用于消费开支）。非常适合用于存钱',
			'account.form.name' => '账户名称',
			'account.form.name_placeholder' => '例如：储蓄账户',
			'account.form.notes' => '备注',
			'account.form.notes_placeholder' => '输入有关此账户的一些备注/描述',
			'account.form.initial_balance' => '初始余额',
			'account.form.current_balance' => '当前余额',
			'account.form.create' => '创建账户',
			'account.form.edit' => '编辑账户',
			'account.form.currency_not_found_warn' => '您没有此货币的汇率信息。将使用默认汇率 1.0。您可以在设置中修改',
			'account.form.already_exists' => '此账户名已存在，请起一个新的账户名',
			'account.form.tr_before_opening_date' => '此账户中有早于开户日期的交易',
			'account.form.iban' => '国际银行账户号码（IBAN）',
			'account.form.swift' => '银行识别码（SWIFT）',
			'account.delete.warning_header' => '删除账户？',
			'account.delete.warning_text' => '此操作将删除此账户及其所有交易',
			'account.delete.success' => '账户删除成功',
			'account.close.title' => '关闭账户',
			'account.close.title_short' => '关闭',
			'account.close.warn' => '此账户将不再出现在特定列表中，并且您无法在此账户中创建晚于以下日期的交易。此操作不会影响任何交易或余额，您也可以随时重新开启此账户。',
			'account.close.should_have_zero_balance' => '此账户中的当前余额必须为 0 才可关闭。请在继续之前编辑账户',
			'account.close.should_have_no_transactions' => '此账户在指定的关闭日期之后仍有交易。请删除它们或编辑账户关闭日期，然后再继续',
			'account.close.success' => '账户关闭成功',
			'account.close.unarchive_succes' => '账户已成功重新开启',
			'account.select.one' => '选择一个账户',
			'account.select.all' => '所有账户',
			'account.select.multiple' => '选择多个账户',
			'currencies.currency_converter' => '货币换算',
			'currencies.currency' => '货币',
			'currencies.currency_settings' => '货币设置',
			'currencies.currency_manager' => '货币管理',
			'currencies.currency_manager_descr' => '设置您的货币及其与其他货币的汇率',
			'currencies.preferred_currency' => '默认货币',
			'currencies.tap_to_change_preferred_currency' => '点击即可更改',
			'currencies.change_preferred_currency_title' => '更改默认货币',
			'currencies.change_preferred_currency_msg' => '从现在起，所有统计数据和预算都将以此货币显示。账户和交易将保留其原有货币单位。如果您执行此操作，所有保存的汇率都将被删除。您想继续吗？',
			'currencies.exchange_rate_form.equal_to_preferred_warn' => '货币不能与用户货币相同',
			'currencies.exchange_rate_form.override_existing_warn' => '该货币在该日期的汇率已存在。如果继续，前一个将会被覆盖',
			'currencies.exchange_rate_form.specify_a_currency' => '请指定货币',
			'currencies.exchange_rate_form.add' => '添加汇率',
			'currencies.exchange_rate_form.add_success' => '汇率添加成功',
			'currencies.exchange_rate_form.edit' => '编辑汇率',
			'currencies.exchange_rate_form.edit_success' => '汇率编辑成功',
			'currencies.exchange_rate_form.remove_all' => '删除所有汇率',
			'currencies.exchange_rate_form.remove_all_warning' => '此操作不可逆转，并将删除该货币的所有汇率',
			'currencies.types.display' => '货币类型',
			'currencies.types.fiat' => '菲亚特',
			'currencies.types.crypto' => '加密货币',
			'currencies.types.other' => '其他',
			'currencies.currency_form.name' => '显示名称',
			'currencies.currency_form.code' => '货币代码',
			'currencies.currency_form.symbol' => '象征',
			'currencies.currency_form.decimal_digits' => '小数位',
			'currencies.currency_form.create' => '创建货币',
			'currencies.currency_form.create_success' => '货币创建成功',
			'currencies.currency_form.edit' => '编辑货币',
			'currencies.currency_form.edit_success' => '货币编辑成功',
			'currencies.currency_form.delete' => '删除货币',
			'currencies.currency_form.delete_success' => '币种删除成功',
			'currencies.currency_form.already_exists' => '具有此代码的货币已存在。您可能想要编辑它',
			'currencies.delete_all_success' => '删除汇率成功',
			'currencies.historical' => '历史汇率',
			'currencies.historical_empty' => '没有找到该货币的历史汇率',
			'currencies.exchange_rate' => '汇率',
			'currencies.exchange_rates' => '汇率',
			'currencies.min_exchange_rate' => '最低汇率',
			'currencies.max_exchange_rate' => '最高汇率',
			'currencies.empty' => '如果您有账户使用默认货币以外的货币，请在此处添加汇率，以获得更准确的图表',
			'currencies.select_a_currency' => '选择货币',
			...
			'tags.empty_list' => '您还没有创建任何标签。标签和类别是对您的动作进行分类的好方法',
			'tags.without_tags' => '没有标签',
			'tags.add' => '添加标签',
			'tags.create' => '创建标签',
			'tags.create_success' => '标签创建成功',
			'tags.already_exists' => '此标签名已存在。请起一个新的标签名',
			'tags.edit' => '编辑标签',
			'tags.edit_success' => '标签编辑成功',
			'tags.delete_success' => '类别删除成功',
			'tags.delete_warning_header' => '删除标签？',
			'tags.delete_warning_message' => '此操作不会删除具有此标签的交易。',
			'categories.unknown' => '未知类别',
			'categories.create' => '创建类别',
			'categories.create_success' => '类别创建成功',
			'categories.new_category' => '新类别',
			'categories.already_exists' => '此类别名已存在。请起一个新的类别名',
			'categories.edit' => '编辑类别',
			'categories.edit_success' => '类别编辑成功',
			'categories.name' => '类别名称',
			'categories.type' => '类别类型',
			'categories.both_types' => '混合类型',
			'categories.subcategories' => '子类别',
			'categories.subcategories_add' => '新增子类别',
			'categories.make_parent' => '移动至类别',
			'categories.make_child' => '移动成为子类别',
			'categories.make_child_warning1' => ({required Object destiny}) => '此类别及其子类别将成为<b>${destiny}</b>的子类别。',
			'categories.make_child_warning2' => ({required Object x, required Object destiny}) => '它们的交易<b>(${x})</b>将被移至<b>${destiny}</b>类别中创建的新子类别。',
			'categories.make_child_success' => '子类别创建成功',
			'categories.merge' => '与另一个类别合并',
			'categories.merge_warning1' => ({required Object from, required Object x, required Object destiny}) => '与类别<b>${from}</b>相关的所有交易 (${x}) 将移至类别<b>${destiny}</b>',
			'categories.merge_warning2' => ({required Object from}) => '类别<b>${from}</b>将被无法撤回地删除。 ',
			'categories.merge_success' => '类别合并成功',
			'categories.delete_success' => '类别删除成功',
			'categories.delete_warning_header' => '删除类别？',
			'categories.delete_warning_message' => ({required Object x}) => '此操作将无法撤回地删除与此类别相关的所有交易<b>(${x})</b>。',
			'categories.select.title' => '选择类别',
			'categories.select.select_one' => '选择一个类别',
			'categories.select.select_subcategory' => '选择一个子类别',
			'categories.select.without_subcategory' => '没有子类别',
			'categories.select.all' => '所有类别',
			'categories.select.all_short' => '全部',
			'budgets.title' => '预算',
			'budgets.status' => '预算状况',
			'budgets.repeated' => '重复的',
			'budgets.one_time' => '单次的',
			'budgets.actives' => '活跃',
			'budgets.from_budgeted' => '预算为',
			'budgets.days_left' => '天还剩',
			'budgets.days_to_start' => '天开始',
			'budgets.since_expiration' => '自到期日起的天数',
			'budgets.no_budgets' => '未发现应当显示的预算。请点击底部的 \'+\' 按钮新增一个预算',
			'budgets.delete' => '删除预算',
			'budgets.delete_warning' => '此操作无法撤回。此预算中的类别和交易不会被删除',
			'budgets.form.title' => '创建预算',
			'budgets.form.name' => '预算名称',
			'budgets.form.value' => '预算额度',
			'budgets.form.create' => '创建预算',
			'budgets.form.create_success' => '预算创建成功',
			'budgets.form.edit' => '编辑预算',
			'budgets.form.edit_success' => '预算编辑成功',
			'budgets.form.negative_warn' => '预算额度不能为负数',
			'budgets.details.title' => '预算详情',
			'budgets.details.statistics' => '统计数据',
			'budgets.details.budget_value' => '预算',
			'budgets.details.expend_evolution' => '支出变化',
			'budgets.details.no_transactions' => '看来您还没有与此预算相关的任何支出',
			'budgets.target_timeline_statuses.active' => '当前预算',
			'budgets.target_timeline_statuses.past' => '已完成预算',
			'budgets.target_timeline_statuses.future' => '未来预算',
			'budgets.progress.labels.active_on_track' => '正常',
			'budgets.progress.labels.active_overspending' => '超支',
			'budgets.progress.labels.active_indeterminate' => '积极的',
			'budgets.progress.labels.success' => '已达成',
			'budgets.progress.labels.fail' => '超出预算',
			'budgets.progress.description.active_on_track' => ({required Object remainingDays, required Object dailyAmount}) => '在剩余的 ${remainingDays} 天里，您每天可以花费 ${dailyAmount}',
			'budgets.progress.description.active_overspending' => ({required Object remainingDays, required Object dailyAmount}) => '为了回到正轨，您应该在剩余的 ${remainingDays} 天里将每天的支出限制在 ${dailyAmount}',
			'budgets.progress.description.active_indeterminate' => ({required Object amount}) => '您还剩 ${amount} 可以消费。',
			'budgets.progress.description.active_exceeded' => ({required Object amount}) => '您已经超出了预算限额 ${amount}。如果您找不到此预算的任何收入，您应该在其剩余期间停止支出',
			'budgets.progress.description.success' => '干得好！该预算已成功完成。继续创建预算以管理您的支出',
			'budgets.progress.description.fail' => ({required Object amount}) => '您超出了预算 ${amount}。下次请更加小心！',
			'goals.title' => '目标',
			'goals.status' => '目标状态',
			'goals.type.display' => '目标类型',
			'goals.type.income.title' => '储蓄目标',
			'goals.type.income.descr' => '非常适合储蓄。当余额超过目标时，即为成功。',
			'goals.type.expense.title' => '支出目标',
			'goals.type.expense.descr' => '跟踪您的支出并以此达到目标金额。适用于捐款、慈善...',
			'goals.empty_title' => '未找到目标',
			'goals.empty_description' => '创建一个新目标以开始追踪您的储蓄！',
			'goals.delete' => '删除目标',
			...
			'goals.form.edit_success' => '目标编辑成功',
			'goals.form.negative_warn' => '目标金额不能为负数',
			'goals.details.title' => '目标详情',
			'goals.details.statistics' => '统计',
			'goals.details.goal_value' => '目标值',
			'goals.details.evolution' => '趋势',
			'goals.details.no_transactions' => '看来您还没有进行任何与此目标相关的交易',
			'goals.target_timeline_statuses.active' => '进行中的目标',
			'goals.target_timeline_statuses.past' => '已结束的目标',
			'goals.target_timeline_statuses.future' => '未来的目标',
			'goals.progress.labels.active_on_track' => '步入正轨',
			'goals.progress.labels.active_behind_schedule' => '落后于计划',
			'goals.progress.labels.active_indeterminate' => '积极的',
			_ => null,
		} ?? switch (path) {
			'goals.progress.labels.success' => '目标达成',
			'goals.progress.labels.fail' => '目标失败',
			'goals.progress.description.active_on_track' => ({required Object remainingDays, required Object dailyAmount}) => '您正在寻找目标的轨道上！您必须在剩余的 ${remainingDays} 天内每天节省 ${dailyAmount}',
			'goals.progress.description.active_behind_schedule' => ({required Object dailyAmount, required Object remainingDays}) => '你落后于计划了。您必须每天节省 ${dailyAmount} 才能在 ${remainingDays} 天后达到您的目标',
			...
			'debts.display' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: 'Debt', other: 'Debts', ), 
			...
			'backup.no_file_selected' => '未选择文件',
			'backup.no_directory_selected' => '未选择目录',
			'backup.export.title' => '导出您的数据',
			'backup.export.title_short' => '导出',
			'backup.export.type_of_export' => '出口类型',
			'backup.export.other_options' => '选项',
			'backup.export.all' => '完整备份',
			'backup.export.all_descr' => '导出您的所有数据（账户、交易、预算、设置……）。随时再次导入它们，您就不会丟失任何內容。',
			'backup.export.transactions' => '交易备份',
			'backup.export.transactions_descr' => '以 CSV 格式导出您的交易，以便您可以在其它程序或应用中更轻松地分析。',
			'backup.export.transactions_to_export' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '1 笔交易要导出', other: '要导出的 ${n} 笔交易', ), 
			'backup.export.description' => '以不同格式下载（导出）数据',
			...
			'backup.import.manual_import.title' => '手动导入',
			'backup.import.manual_import.descr' => '手动从 .csv 文件导入交易',
			...
			'backup.import.manual_import.steps_descr.1' => '选择每笔交易数额的列。负值表示支出，正值表示收入。.表示小数点分隔符。',
			...
			'backup.about.last_backup' => '上次备份',
			'backup.about.size' => '文件大小',
			'settings.title_long' => '设置与自定义',
			'settings.title_short' => '设置',
			'settings.description' => '主题、语言、数据等',
			'settings.edit_profile' => '编辑个人资料',
			'settings.general.menu_title' => '常规设置',
			'settings.general.menu_descr' => '语言、隐私等',
			'settings.general.show_all_decimals' => '显示所有小数位',
			'settings.general.show_all_decimals_descr' => '即便是末尾为零，也显示所有小数位',
			...
			'settings.general.locale.warn' => '更改区域时应用将更新',
			'settings.general.locale.first_day_of_week' => '一周的第一天',
			'settings.security.title' => '安全',
			'settings.security.private_mode_at_launch' => '启动隐私模式',
			'settings.security.private_mode_at_launch_descr' => '默认以隐私模式启动此应用',
			'settings.security.private_mode' => '隐私模式',
			'settings.security.private_mode_descr' => '隐藏所有金额',
			'settings.security.private_mode_activated' => '隐私模式已启用',
			'settings.security.private_mode_deactivated' => '隐私模式已禁用',
			...
			'settings.security.biometric.section_title' => '生物识别锁',
			'settings.transactions.menu_title' => '交易',
			'settings.transactions.menu_descr' => '配置交易的行为',
			'settings.transactions.title' => '交易设置',
			'settings.transactions.style.title' => '交易样式',
			'settings.transactions.style.subtitle' => '配置交易在应用列表中的显示方式',
			'settings.transactions.style.show_tags' => '显示标签',
			'settings.transactions.style.show_time' => '显示时间',
			'settings.transactions.swipe_actions.title' => '滑动操作',
			'settings.transactions.swipe_actions.choose_description' => '选择当您使用此滑动方向滑动列表中的交易项目时将触发什么操作',
			'settings.transactions.swipe_actions.swipe_left' => '向左滑动',
			'settings.transactions.swipe_actions.swipe_right' => '向右滑动',
			'settings.transactions.swipe_actions.none' => '无动作',
			'settings.transactions.swipe_actions.toggle_reconciled' => '切换已调节',
			'settings.transactions.swipe_actions.toggle_pending' => '切换待处理',
			'settings.transactions.swipe_actions.toggle_voided' => '切换作废',
			'settings.transactions.swipe_actions.toggle_unreconciled' => '切换不可调和',
			'settings.transactions.swipe_actions.remove_status' => '删除状态',
			...
			'settings.auto_import.menu_title' => '银行自动导入',
			'settings.appearance.menu_title' => '主题与风格',
			'settings.appearance.menu_descr' => '主题选择、颜色以及与应用程序外观相关的其他内容',
			'settings.appearance.theme_and_colors' => '主题和颜色',
			'settings.appearance.theme.title' => '主题',
			'settings.appearance.theme.auto' => '系统',
			'settings.appearance.theme.light' => '明亮主题',
			'settings.appearance.theme.dark' => '黑暗主题',
			'settings.appearance.amoled_mode' => 'AMOLED 模式',
			'settings.appearance.amoled_mode_descr' => '尽可能使用纯黑色壁纸。在 AMOLED 屏幕的设备上能略微省电',
			'settings.appearance.dynamic_colors' => '动态色彩',
			'settings.appearance.dynamic_colors_descr' => '尽可能使用系统强调色',
			'settings.appearance.accent_color' => '强调色',
			'settings.appearance.accent_color_descr' => '选择应用中用来强调介面某些部分的颜色',
			...
			'more.data.display_descr' => '导出和导入您的数据，这样您不会丟失任何东西',
			'more.data.delete_all' => '删除我的数据',
			'more.data.delete_all_header1' => '停下⚠️⚠️',
			'more.data.delete_all_message1' => '您确定要继续吗？您的所有数据将永久删除且无法恢复',
			...
			'more.help_us.donate_err' => '糟糕！接收您的付款时出现错误',
			'more.help_us.report' => '报告错误，留下建议……',
			_ => null,
		};
	}
}
