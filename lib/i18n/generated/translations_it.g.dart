...
class _TranslationsHomeIt extends TranslationsHomeEn {
	...
	@override String get no_accounts_descr => 'Inizia a usare tutta la magia di NITIDO. Crea almeno un conto per iniziare ad aggiungere transazioni';
...
class _TranslationsSettingsIt extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsAutoImportIt auto_import = _TranslationsSettingsAutoImportIt._(_root);
...
class _TranslationsMoreIt extends TranslationsMoreEn {
	...
	@override late final _TranslationsMoreSearchIt search = _TranslationsMoreSearchIt._(_root);
	@override late final _TranslationsMoreSectionsIt sections = _TranslationsMoreSectionsIt._(_root);
	@override late final _TranslationsMoreAccountIt account = _TranslationsMoreAccountIt._(_root);
	@override late final _TranslationsMoreThemeIt theme = _TranslationsMoreThemeIt._(_root);
	@override late final _TranslationsMoreAiIt ai = _TranslationsMoreAiIt._(_root);
...
class _TranslationsTransactionStatusIt extends TranslationsTransactionStatusEn {
	...
	@override String get unreconciled_descr => 'Questa transazione non è ancora stata convalidata e pertanto non appare ancora nei tuoi conti bancari reali. Tuttavia, conta per il calcolo dei saldi e delle statistiche in NITIDO';
...
class _TranslationsBackupImportIt extends TranslationsBackupImportEn {
	...
	@override String get restore_backup_descr => 'Importa un database precedentemente salvato da NITIDO. Questa azione sostituirà tutti i dati attuali dell\'applicazione con i nuovi dati';
	@override String get restore_backup_warn_description => 'Importando un nuovo database, perderai tutti i dati attualmente salvati nell\'app. Si consiglia di effettuare un backup prima di continuare. Non caricare qui alcun file la cui origine non conosci, carica solo file che hai precedentemente scaricato da NITIDO';
...
class _TranslationsSettingsSecurityIt extends TranslationsSettingsSecurityEn {
	...
	@override late final _TranslationsSettingsSecurityBiometricIt biometric = _TranslationsSettingsSecurityBiometricIt._(_root);
}
...
class _TranslationsSettingsAutoImportIt extends TranslationsSettingsAutoImportEn {
	_TranslationsSettingsAutoImportIt._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get menu_title => 'Importazione bancaria automatica';
}
...
// Path: more.search
class _TranslationsMoreSearchIt extends TranslationsMoreSearchEn {
	_TranslationsMoreSearchIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: more.sections
class _TranslationsMoreSectionsIt extends TranslationsMoreSectionsEn {
	_TranslationsMoreSectionsIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: more.account
class _TranslationsMoreAccountIt extends TranslationsMoreAccountEn {
	_TranslationsMoreAccountIt._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override String get firebase_sync => 'Sincronizzazione Firebase';
}

// Path: more.theme
class _TranslationsMoreThemeIt extends TranslationsMoreThemeEn {
	_TranslationsMoreThemeIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: more.ai
class _TranslationsMoreAiIt extends TranslationsMoreAiEn {
	_TranslationsMoreAiIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsMoreAboutUsIt extends TranslationsMoreAboutUsEn {
	...
	@override String get description => 'Trova i termini di NITIDO, informazioni importanti e connettiti segnalando bug o condividendo idee';
...
class _TranslationsMoreHelpUsIt extends TranslationsMoreHelpUsEn {
	...
	@override String get description => 'Scopri come puoi aiutare NITIDO a migliorare sempre di più';
	@override String get rate_us => 'Valutaci';
	@override String get rate_us_descr => 'Ogni valutazione è benvenuta!';
	@override String get share => 'Condividi NITIDO';
	@override String get share_descr => 'Condividi la nostra app con amici e famiglia';
	@override String get share_text => 'NITIDO! La migliore app di finanza personale. Scaricala qui';
	@override String get thanks => 'Grazie!';
	@override String get thanks_long => 'I tuoi contributi a NITIDO e ad altri progetti open source, grandi e piccoli, rendono possibili grandi progetti come questo. Grazie per aver dedicato tempo a contribuire.';
...
class _TranslationsFinancialHealthReviewDescrIt extends TranslationsFinancialHealthReviewDescrEn {
	...
	@override String get very_good => 'Congratulazioni! La tua salute finanziaria è eccezionale. Speriamo che continui la tua buona serie e continui a imparare con NITIDO';
...
class _TranslationsTransactionFormValidatorsIt extends TranslationsTransactionFormValidatorsEn {
	...
	@override String get category_required => 'Seleziona una categoria prima di salvare';
}
...
class _TranslationsSettingsGeneralLanguageIt extends TranslationsSettingsGeneralLanguageEn {
	...
	@override String get help => 'Se vuoi collaborare con le traduzioni di questa app, puoi consultare <a href=\'__NITIDO_GITHUB_URL__/tree/main/lib/i18n\'>la nostra guida</a>';
}
...
class _TranslationsSettingsSecurityBiometricIt extends TranslationsSettingsSecurityBiometricEn {
	_TranslationsSettingsSecurityBiometricIt._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override String get section_title => 'Blocco biometrico';
}
...
class _TranslationsMoreAboutUsProjectIt extends TranslationsMoreAboutUsProjectEn {
	...
	@override String get contributors_descr => 'Tutti gli sviluppatori che hanno fatto crescere NITIDO';
...
extension on TranslationsIt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'home.no_accounts_descr' => 'Inizia a usare tutta la magia di NITIDO. Crea almeno un conto per iniziare ad aggiungere transazioni',
			...
			'financial_health.review.descr.very_good' => 'Congratulazioni! La tua salute finanziaria è eccezionale. Speriamo che continui la tua buona serie e continui a imparare con NITIDO',
			...
			'transaction.form.validators.category_required' => 'Seleziona una categoria prima di salvare',
			...
			'transaction.status.unreconciled_descr' => 'Questa transazione non è ancora stata convalidata e pertanto non appare ancora nei tuoi conti bancari reali. Tuttavia, conta per il calcolo dei saldi e delle statistiche in NITIDO',
			...
			'debts.display' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('it'))(n, one: 'Debt', other: 'Debts', ), 
			...
			'backup.import.restore_backup_descr' => 'Importa un database precedentemente salvato da NITIDO. Questa azione sostituirà tutti i dati attuali dell\'applicazione con i nuovi dati',
			'backup.import.restore_backup_warn_description' => 'Importando un nuovo database, perderai tutti i dati attualmente salvati nell\'app. Si consiglia di effettuare un backup prima di continuare. Non caricare qui alcun file la cui origine non conosci, carica solo file che hai precedentemente scaricato da NITIDO',
			...
			'backup.import.manual_import.steps_descr.1' => 'Seleziona la colonna in cui è specificato il valore di ogni transazione. Usa valori negativi per le spese e valori positivi per le entrate. Usa un punto come separatore decimale',
			...
			'settings.general.language.help' => 'Se vuoi collaborare con le traduzioni di questa app, puoi consultare <a href=\'__NITIDO_GITHUB_URL__/tree/main/lib/i18n\'>la nostra guida</a>',
			...
			'settings.security.biometric.section_title' => 'Blocco biometrico',
			...
			'settings.auto_import.menu_title' => 'Importazione bancaria automatica',
			...
			'more.account.firebase_sync' => 'Sincronizzazione Firebase',
			...
			'more.about_us.description' => 'Trova i termini di NITIDO, informazioni importanti e connettiti segnalando bug o condividendo idee',
			...
			'more.about_us.project.contributors_descr' => 'Tutti gli sviluppatori che hanno fatto crescere NITIDO',
			'more.about_us.project.contact' => 'Contattaci',
			'more.help_us.display' => 'Aiutaci',
			'more.help_us.description' => 'Scopri come puoi aiutare NITIDO a migliorare sempre di più',
			'more.help_us.rate_us' => 'Valutaci',
			'more.help_us.rate_us_descr' => 'Ogni valutazione è benvenuta!',
			'more.help_us.share' => 'Condividi NITIDO',
			'more.help_us.share_descr' => 'Condividi la nostra app con amici e famiglia',
			'more.help_us.share_text' => 'NITIDO! La migliore app di finanza personale. Scaricala qui',
			'more.help_us.thanks' => 'Grazie!',
			'more.help_us.thanks_long' => 'I tuoi contributi a NITIDO e ad altri progetti open source, grandi e piccoli, rendono possibili grandi progetti come questo. Grazie per aver dedicato tempo a contribuire.',
