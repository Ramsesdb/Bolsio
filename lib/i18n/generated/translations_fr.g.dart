...
class _TranslationsHomeFr extends TranslationsHomeEn {
	...
	@override String get no_accounts_descr => 'Commencez à profiter de toute la magie de NITIDO. Créez au moins un compte pour commencer à ajouter des transactions.';
...
class _TranslationsTransactionStatusFr extends TranslationsTransactionStatusEn {
	...
	@override String get unreconciled_descr => 'Cette transaction n\'a pas encore été validée et n\'apparaît donc pas encore dans vos comptes bancaires réels. Cependant, elle est prise en compte pour le calcul des soldes et des statistiques dans NITIDO';
...
class _TranslationsMoreAboutUsFr extends TranslationsMoreAboutUsEn {
	...
	@override String get description => 'Trouvez les conditions de NITIDO, des informations importantes, et connectez-vous en signalant des bugs ou en partageant des idées';
...
class _TranslationsMoreHelpUsFr extends TranslationsMoreHelpUsEn {
	...
	@override String get description => 'Découvrez comment vous pouvez aider NITIDO à devenir toujours meilleur';
	@override String get rate_us => 'Notez-nous';
	@override String get rate_us_descr => 'Toutes les notes sont les bienvenues !';
	@override String get share => 'Partager NITIDO';
	@override String get share_descr => 'Partagez notre application avec vos amis et votre famille';
	@override String get share_text => 'NITIDO ! La meilleure application de finances personnelles. Téléchargez-la ici';
	@override String get thanks => 'Merci !';
	@override String get thanks_long => 'Vos contributions à NITIDO et aux autres projets open source, grandes ou petites, rendent possibles de super projets comme celui-ci. Merci de prendre le temps de contribuer.';
...
class _TranslationsFinancialHealthReviewDescrFr extends TranslationsFinancialHealthReviewDescrEn {
	...
	@override String get very_good => 'Félicitations ! Votre santé financière est excellente. Nous espérons que vous continuerez sur cette lancée et à apprendre avec NITIDO.';
...
class _TranslationsSettingsGeneralLanguageFr extends TranslationsSettingsGeneralLanguageEn {
	...
	@override String get help => 'Si vous souhaitez contribuer aux traductions de cette application, vous pouvez consulter <a href=\'__NITIDO_GITHUB_URL__/tree/main/lib/i18n\'>notre guide</a>';
}
...
class _TranslationsMoreAboutUsProjectFr extends TranslationsMoreAboutUsProjectEn {
	...
	@override String get contributors_descr => 'Tous les développeurs qui ont fait grandir NITIDO';
...
extension on TranslationsFr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'home.no_accounts_descr' => 'Commencez à profiter de toute la magie de NITIDO. Créez au moins un compte pour commencer à ajouter des transactions.',
			...
			'financial_health.review.descr.very_good' => 'Félicitations ! Votre santé financière est excellente. Nous espérons que vous continuerez sur cette lancée et à apprendre avec NITIDO.',
			...
			'transaction.status.unreconciled_descr' => 'Cette transaction n\'a pas encore été validée et n\'apparaît donc pas encore dans vos comptes bancaires réels. Cependant, elle est prise en compte pour le calcul des soldes et des statistiques dans NITIDO',
			...
			'backup.import.restore_backup_descr' => 'Importez une base de données NITIDO préalablement sauvegardée. Cette action remplacera toutes les données actuelles de l\'application par les nouvelles données',
			...
			'settings.general.language.help' => 'Si vous souhaitez contribuer aux traductions de cette application, vous pouvez consulter <a href=\'__NITIDO_GITHUB_URL__/tree/main/lib/i18n\'>notre guide</a>',
			...
			'more.about_us.description' => 'Trouvez les conditions de NITIDO, des informations importantes, et connectez-vous en signalant des bugs ou en partageant des idées',
			...
			'more.about_us.project.contributors_descr' => 'Tous les développeurs qui ont fait grandir NITIDO',
			'more.about_us.project.contact' => 'Contactez-nous',
			'more.help_us.display' => 'Aidez-nous',
			'more.help_us.description' => 'Découvrez comment vous pouvez aider NITIDO à devenir toujours meilleur',
			'more.help_us.rate_us' => 'Notez-nous',
			'more.help_us.rate_us_descr' => 'Toutes les notes sont les bienvenues !',
			'more.help_us.share' => 'Partager NITIDO',
			'more.help_us.share_descr' => 'Partagez notre application avec vos amis et votre famille',
			'more.help_us.share_text' => 'NITIDO ! La meilleure application de finances personnelles. Téléchargez-la ici',
			'more.help_us.thanks' => 'Merci !',
			'more.help_us.thanks_long' => 'Vos contributions à NITIDO et aux autres projets open source, grandes ou petites, rendent possibles de super projets comme celui-ci. Merci de prendre le temps de contribuer.',
