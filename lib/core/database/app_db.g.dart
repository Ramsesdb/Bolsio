...
class Users extends Table with TableInfo<Users, UserInDB> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  late final GeneratedColumn<String> role = GeneratedColumn<String>(
    ...
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT \'viewer\' CHECK (role IN (\'admin\', \'treasurer\', \'viewer\'))',
    defaultValue: const CustomExpression('\'viewer\''),
  );
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  UserInDB map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return UserInDB(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class UserInDB extends DataClass implements Insertable<UserInDB> {
  /// Firebase UID
  final String id;
  ...
  /// User role: admin (full access), treasurer (can edit), viewer (read-only)
  final String role;
  ...
  UserInDB copyWithCompanion(UsersCompanion data) {
    return UserInDB(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  int get hashCode =>
      Object.hash(id, email, displayName, role, createdAt, lastLogin);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is UserInDB &&
...
class UsersCompanion extends UpdateCompanion<UserInDB> {
  final Value<String> id;
  ...
  UsersCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       email = Value(email),
       createdAt = Value(createdAt);
  static Insertable<UserInDB> custom({
    Expression<String>? id,
...
class Transactions extends Table with TableInfo<Transactions, TransactionInDB> {
  ...
  static const VerificationMeta _exchangeRateAppliedMeta =
      const VerificationMeta('exchangeRateApplied');
  late final GeneratedColumn<double> exchangeRateApplied =
  ...
  exchangeRateSource = GeneratedColumn<String>(
    'exchangeRateSource',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('exchangeRateApplied')) {
      context.handle(
        _exchangeRateAppliedMeta,
        exchangeRateApplied.isAcceptableOrUnknown(
          data['exchangeRateApplied']!,
          _exchangeRateAppliedMeta,
        ),
      );
    }
    if (data.containsKey('exchangeRateSource')) {
      context.handle(
    ...
    if (data.containsKey('modifiedBy')) {
      context.handle(
        _modifiedByMeta,
        modifiedBy.isAcceptableOrUnknown(data['modifiedBy']!, _modifiedByMeta),
      );
    }
    if (data.containsKey('createdAt')) {
      context.handle(
  ...
  TransactionInDB map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return TransactionInDB(
      ...
      exchangeRateApplied: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}exchangeRateApplied'],
      ),
      exchangeRateSource: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}exchangeRateSource'],
      ),
      ...
      modifiedBy: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}modifiedBy'],
      ),
      createdAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}createdAt'],
...
class TransactionInDB extends DataClass implements Insertable<TransactionInDB> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || exchangeRateApplied != null) {
      map['exchangeRateApplied'] = Variable<double>(exchangeRateApplied);
    }
    if (!nullToAbsent || exchangeRateSource != null) {
      map['exchangeRateSource'] = Variable<String>(exchangeRateSource);
    }
    if (!nullToAbsent || createdBy != null) {
      map['createdBy'] = Variable<String>(createdBy);
    }
    if (!nullToAbsent || modifiedBy != null) {
      map['modifiedBy'] = Variable<String>(modifiedBy);
    }
    map['createdAt'] = Variable<DateTime>(createdAt);
    if (!nullToAbsent || modifiedAt != null) {
      map['modifiedAt'] = Variable<DateTime>(modifiedAt);
    }
  ...
  TransactionsCompanion toCompanion(bool nullToAbsent) {
    return TransactionsCompanion(
      ...
      exchangeRateApplied: exchangeRateApplied == null && nullToAbsent
          ? const Value.absent()
          : Value(exchangeRateApplied),
  ...
  factory TransactionInDB.fromJson(
    ...
    return TransactionInDB(
      ...
      exchangeRateApplied: serializer.fromJson<double?>(
        json['exchangeRateApplied'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'exchangeRateApplied': serializer.toJson<double?>(exchangeRateApplied),
  ...
  TransactionInDB copyWith({
    ...
    bool? isHidden,
    Value<double?> exchangeRateApplied = const Value.absent(),
    ...
    exchangeRateApplied: exchangeRateApplied.present
        ? exchangeRateApplied.value
        : this.exchangeRateApplied,
  ...
  TransactionInDB copyWithCompanion(TransactionsCompanion data) {
    return TransactionInDB(
      ...
      exchangeRateApplied: data.exchangeRateApplied.present
          ? data.exchangeRateApplied.value
          : this.exchangeRateApplied,
  ...
  String toString() {
    return (StringBuffer('TransactionInDB(')
          ...
          ..write('exchangeRateApplied: $exchangeRateApplied, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is TransactionInDB &&
          ...
          other.exchangeRateApplied == this.exchangeRateApplied &&
...
class TransactionsCompanion extends UpdateCompanion<TransactionInDB> {
  ...
  final Value<double?> exchangeRateApplied;
  ...
  const TransactionsCompanion({
    ...
    this.exchangeRateApplied = const Value.absent(),
  ...
  static Insertable<TransactionInDB> custom({
    ...
    Expression<double>? exchangeRateApplied,
    ...
    return RawValuesInsertable({
      ...
      if (exchangeRateSource != null) 'exchangeRateSource': exchangeRateSource,
  ...
  TransactionsCompanion copyWith({
    ...
    Value<bool>? isHidden,
    Value<double?>? exchangeRateApplied,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (exchangeRateApplied.present) {
      map['exchangeRateApplied'] = Variable<double>(exchangeRateApplied.value);
    }
    if (exchangeRateSource.present) {
      map['exchangeRateSource'] = Variable<String>(exchangeRateSource.value);
    }
    if (createdBy.present) {
      map['createdBy'] = Variable<String>(createdBy.value);
    }
    if (modifiedBy.present) {
      map['modifiedBy'] = Variable<String>(modifiedBy.value);
    }
    if (createdAt.present) {
      map['createdAt'] = Variable<DateTime>(createdAt.value);
    }
    if (modifiedAt.present) {
      map['modifiedAt'] = Variable<DateTime>(modifiedAt.value);
    }
  ...
  Selectable<MoneyTransaction> getTransactionsWithFullData({
    ...
    return customSelect(
      ...
      (QueryRow row) async => MoneyTransaction(
        ...
        exchangeRateApplied: row.readNullable<double>('exchangeRateApplied'),
        exchangeRateSource: row.readNullable<String>('exchangeRateSource'),
...
class $UsersFilterComposer extends Composer<_$AppDB, Users> {
  $UsersFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $UsersOrderingComposer extends Composer<_$AppDB, Users> {
...
class $UsersAnnotationComposer extends Composer<_$AppDB, Users> {
...
class $UsersTableManager
    extends
        RootTableManager<
          ...
          (UserInDB, BaseReferences<_$AppDB, Users, UserInDB>),
          UserInDB,
          PrefetchHooks Function()
        > {
  $UsersTableManager(_$AppDB db, Users table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
final class $TransactionsReferences
  ...
  static Users _createdByTable(_$AppDB db) => db.users.createAlias(
    $_aliasNameGenerator(db.transactions.createdBy, db.users.id),
  );

  $UsersProcessedTableManager? get createdBy {
    final $_column = $_itemColumn<String>('createdBy');
    if ($_column == null) return null;
  ...
  static Users _modifiedByTable(_$AppDB db) => db.users.createAlias(
    $_aliasNameGenerator(db.transactions.modifiedBy, db.users.id),
  );

  $UsersProcessedTableManager? get modifiedBy {
    final $_column = $_itemColumn<String>('modifiedBy');
    if ($_column == null) return null;
    final manager = $UsersTableManager(
      $_db,
      $_db.users,
...
class $TransactionsFilterComposer extends Composer<_$AppDB, Transactions> {
  ...
  ColumnFilters<double> get exchangeRateApplied => $composableBuilder(
    column: $table.exchangeRateApplied,
    builder: (column) => ColumnFilters(column),
  );
  ...
  $UsersFilterComposer get modifiedBy {
    final $UsersFilterComposer composer = $composerBuilder(
      composer: this,
...
class $TransactionsOrderingComposer extends Composer<_$AppDB, Transactions> {
  ...
  ColumnOrderings<double> get exchangeRateApplied => $composableBuilder(
    column: $table.exchangeRateApplied,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  $UsersOrderingComposer get modifiedBy {
    final $UsersOrderingComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.modifiedBy,
      referencedTable: $db.users,
...
class $TransactionsAnnotationComposer extends Composer<_$AppDB, Transactions> {
  ...
  GeneratedColumn<double> get exchangeRateApplied => $composableBuilder(
    column: $table.exchangeRateApplied,
    builder: (column) => column,
  );
  ...
  $UsersAnnotationComposer get modifiedBy {
    final $UsersAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.modifiedBy,
      referencedTable: $db.users,
